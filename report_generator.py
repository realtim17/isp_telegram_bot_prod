...
=======
            ...
            'ВОЛС (всего)',
            'Витая пара (всего)',
            'Внеш. витая пара (всего)',
            'Внут. витая пара (всего)',
            'ВОЛС на исполнителя',
            'Витая пара на исполнителя',
            'Внеш. витая пара на исполнителя',
            'Внут. витая пара на исполнителя',
            'SNR бокс',
            'ONU',
            'Медиаконверторы',
            'SFP модули',
...
=======
        ...
        ws.column_dimensions['J'].width = 16  # Внеш. витая пара всего
        ws.column_dimensions['K'].width = 16  # Внут. витая пара всего
        ws.column_dimensions['L'].width = 16  # ВОЛС на исполнителя
        ws.column_dimensions['M'].width = 16  # Витая пара на исполнителя
        ws.column_dimensions['N'].width = 18  # Внеш. витая пара на исполнителя
        ws.column_dimensions['O'].width = 18  # Внут. витая пара на исполнителя
        ws.column_dimensions['P'].width = 18  # SNR бокс
        ws.column_dimensions['Q'].width = 18  # ONU
        ws.column_dimensions['R'].width = 22  # МК
        ws.column_dimensions['S'].width = 18  # SFP модули
        ws.column_dimensions['T'].width = 14  # Крюки
        ws.column_dimensions['U'].width = 14  # ORK
        ws.column_dimensions['V'].width = 14  # Муфты
        ws.column_dimensions['W'].width = 16  # Крюки на исполнителя
        ws.column_dimensions['X'].width = 18  # ОРК / ОРШ на исполнителя
        ws.column_dimensions['Y'].width = 16  # Муфты на исполнителя
        ws.column_dimensions['Z'].width = 20  # Доступ на роутер
        ws.column_dimensions['AA'].width = 18  # Договор
        ws.column_dimensions['AB'].width = 18  # Телеграмм Бот
        ws.column_dimensions['AC'].width = 20  # Связь с подключением
        ws.column_dimensions['AD'].width = 18  # Лицевой счет
        ws.column_dimensions['AE'].width = 30  # Bitrix24
        ws.column_dimensions['AF'].width = 30  # Комментарий
>>>>>>> Stashed changes
...
=======
                ...
                conn.get('total_twisted_pair_external_meters', conn.get('twisted_pair_external_meters', 0)),
                conn.get('total_twisted_pair_internal_meters', conn.get('twisted_pair_internal_meters', 0)),
                conn['employee_fiber_meters'],
                conn['employee_twisted_pair_meters'],
                conn.get('employee_twisted_pair_external_meters', 0),
                conn.get('employee_twisted_pair_internal_meters', 0),
                snr_display,
                conn.get('onu_spent', '-'),
                ...
                telegram_status,
                connection_link,
                conn.get('account_number') or "-",
                conn.get('bitrix_task_url') or "-",
                conn.get('comment') or "-",
>>>>>>> Stashed changes
            ]
...
=======
                if col_num in [8, 9, 10, 11, 12, 13, 14, 15]:  # Числовые столбцы
>>>>>>> Stashed changes
...
=======
        ...
        cell.value = stats.get('total_connection_twisted_pair_external_meters', stats.get('total_twisted_pair_external_meters', 0))
        cell.font = total_font
        cell.fill = total_fill
        cell.alignment = number_alignment
        cell.number_format = '0.00'
        ...
        cell.value = stats.get('total_connection_twisted_pair_internal_meters', stats.get('total_twisted_pair_internal_meters', 0))
        cell.font = total_font
        cell.fill = total_fill
        cell.alignment = number_alignment
        cell.number_format = '0.00'
        ...
        # Итого по материалам
        general_materials = [
            (16, stats.get('total_snr_quantity')),
            (17, stats.get('total_onu_quantity')),
            (18, stats.get('total_media_quantity')),
            (19, stats.get('total_sfp_quantity')),
            (20, stats.get('total_hooks_quantity')),
            (21, stats.get('total_ork_quantity')),
            (22, stats.get('total_mufta_quantity')),
        ]
...
>>>>>>> Stashed changes
        ...
        cell.value = stats.get('total_twisted_pair_external_meters', 0)
        cell.font = employee_total_font
        cell.fill = employee_total_fill
        cell.alignment = number_alignment
        cell.number_format = '0.00'
        ...
        cell.value = stats.get('total_twisted_pair_internal_meters', 0)
        cell.font = employee_total_font
        cell.fill = employee_total_fill
        cell.alignment = number_alignment
        cell.number_format = '0.00'
...
=======
        ...
        employee_materials = [
            (23, stats.get('total_employee_hooks')),
            (24, stats.get('total_employee_ork')),
            (25, stats.get('total_employee_mufta')),
        ]
    ...
    def generate_global_report(
        ...
        for idx, conn in enumerate(connections, 1):
            ...
            for col_num, value in enumerate(row_data, 1):
                ...
                if col_num in [8, 9, 10, 11, 12, 13, 14, 15]:
                    cell.alignment = number_alignment
                    cell.number_format = '0.00'
                else:
                    cell.alignment = cell_alignment
...
<<<<<<< Updated upstream
                'router': 'Роутер'
=======
                'twisted_pair_external': 'Внеш. витая пара',
                'twisted_pair_internal': 'Внут. витая пара',
                'router': 'Роутер',
                'snr_box': 'SNR бокс',
                'onu': 'ONU',
