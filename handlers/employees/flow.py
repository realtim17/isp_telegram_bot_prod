...
<<<<<<< Updated upstream
=======
    async def enter_twisted_internal_amount(self, update, context):
        return await materials.enter_twisted_internal_amount(self, update, context)
...
=======
    ...
    async def tmc_enter_twisted_internal(self, update, context):
        return await tmc_flow.enter_twisted_internal(self, update, context)
...
=======
                ENTER_TWISTED_INTERNAL_AMOUNT: [
                    MessageHandler(text_input_filter, self.enter_twisted_internal_amount)
                ],
                CONFIRM_MATERIAL_OPERATION: [
                    CallbackQueryHandler(
...
=======
                ...
                TMC_ENTER_TWISTED_INTERNAL: [
                    MessageHandler(text_input_filter, self.tmc_enter_twisted_internal)
                ],
                TMC_SELECT_ROUTER: [
